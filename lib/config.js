...
ConfigurationBucket.ENV_SCHEMA = joi
  .object({
    ...
    SUNNY_AGGREGATION_INTERVAL: joi.number().default(FALLBACK_AGGREGATION_INTERVAL),
    SUNNY_PLANT_FETCH_INTERVAL: joi.number().default(FALLBACK_PLANT_FETCH_INTERVAL)
  })
  .unknown()
  .required();
