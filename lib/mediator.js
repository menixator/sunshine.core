    ...
    for (let [idx, plant] of plants.entries()) {
      ...
      let row = {
        ...
        yield: {
          ...
          month: {
            value:
              (monthOverview.summary && monthOverview.summary.difference) || -1,
            unit: (monthOverview.summary && monthOverview.summary.unit) || null
          },
          year: {
            value:
              (yearOverview.summary && yearOverview.summary.difference) || -1,
            unit: (yearOverview.summary && yearOverview.summary.unit) || null
          },
          total: {
            value: (todayOverview && todayOverview.absolute) || -1,
        ...
        specificYield: {
          ...
          year: {
            value: yearOverview.summary
              ...
              : -1,
            unit: yearOverview.summary ? `${yearOverview.summary && yearOverview.summary.unit}/${
              peakPower.unit
            }` : null
          }
        }
