...
class BaseReponse {
  ...
  constructor(body) {
    this.log = formatter(
      "sunshine:responses:" + this.constructor.name.toLowerCase()
    );
    ...
    this.creationDate = new Date(this.creationDateString).getTime();
    this.deltaValue = Date.now()-this.creationDate.valueOf();
