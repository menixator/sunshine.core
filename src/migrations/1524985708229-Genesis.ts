...
export class genesis1524985708229 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "equipments" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "comparator" varchar NOT NULL, "locationId" integer)`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_2c98e0f24ec2b22c32928cd6a4" ON "realms" ("name") `);
        await queryRunner.query(`CREATE TABLE "cluster" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_equipments" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "comparator" varchar NOT NULL, "locationId" integer, CONSTRAINT "FK_b28ca28d82d6b0109f30d9580b8" FOREIGN KEY ("locationId") REFERENCES "realms" ("id"))`);
        await queryRunner.query(`INSERT INTO "temporary_equipments"("id", "name", "comparator", "locationId") SELECT "id", "name", "comparator", "locationId" FROM "equipments"`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_a8cfc2466b08483257f8b6b600" ON "equipments" ("comparator") `);
        await queryRunner.query(`DROP INDEX "IDX_2c98e0f24ec2b22c32928cd6a4"`);
        await queryRunner.query(`CREATE TABLE "temporary_realms" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "parentId" integer, CONSTRAINT "FK_65075fc5e8cbe6a98aa6b34c29c" FOREIGN KEY ("parentId") REFERENCES "cluster" ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "equipments" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "comparator" varchar NOT NULL, "locationId" integer)`);
        await queryRunner.query(`INSERT INTO "equipments"("id", "name", "comparator", "locationId") SELECT "id", "name", "comparator", "locationId" FROM "temporary_equipments"`);
